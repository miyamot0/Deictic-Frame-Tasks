...
public class SimpleFrame15 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.simpleframe15);
		...
		Button OneYes = (Button) findViewById(R.id.SimpleFifteenButton1);
		Button OneNo = (Button) findViewById(R.id.SimpleFifteenButton2);		
		Button OneYesOne = (Button) findViewById(R.id.SimpleFifteenButton3);
		Button OneNoTwo = (Button) findViewById(R.id.SimpleFifteenButton4);		
		Button TwoYes = (Button) findViewById(R.id.SimpleFifteenButton5);
		Button TwoNo = (Button) findViewById(R.id.SimpleFifteenButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.SimpleFifteenButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.SimpleFifteenButton8);				
		Button ThreeYes = (Button) findViewById(R.id.SimpleFifteenButton9);
		Button ThreeNo = (Button) findViewById(R.id.SimpleFifteenButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.SimpleFifteenButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.SimpleFifteenButton12);
		Button FourYes = (Button) findViewById(R.id.SimpleFifteenButton13);
		Button FourNo = (Button) findViewById(R.id.SimpleFifteenButton14);				
		Button FourYesOne = (Button) findViewById(R.id.SimpleFifteenButton15);
		Button FourNoTwo = (Button) findViewById(R.id.SimpleFifteenButton16);		
		Button FiveYes = (Button) findViewById(R.id.SimpleFifteenButton17);
		Button FiveNo = (Button) findViewById(R.id.SimpleFifteenButton18);
		Button FiveYesOne = (Button) findViewById(R.id.SimpleFifteenButton19);
		Button FiveNoTwo = (Button) findViewById(R.id.SimpleFifteenButton20);		
		Button SixYes = (Button) findViewById(R.id.SimpleFifteenButton21);
		Button SixNo = (Button) findViewById(R.id.SimpleFifteenButton22);
		Button SixYesOne = (Button) findViewById(R.id.SimpleFifteenButton23);
		Button SixNoTwo = (Button) findViewById(R.id.SimpleFifteenButton24);
		...
		OneNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionOne));
					alertDialog.show();
					wrongSound.start();
					p1q1=false;
					}
		...
		OneNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q2 && !p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionTwo));
					alertDialog.show();
					wrongSound.start();
					p1q2=false;
		...
		TwoNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q1 && !p1q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionThree));
					alertDialog.show();
					wrongSound.start();
					p2q1=false;
					}				
		...
		TwoNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q2 && !p2q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionFour));
					alertDialog.show();
					wrongSound.start();
					p2q2=false;
		...
		ThreeNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q1 && !p2q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionFive));
					alertDialog.show();
					wrongSound.start();
					p3q1=false;
				}
		...
		ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q2 && !p3q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionSix));
					alertDialog.show();
					wrongSound.start();
					p3q2=false;
					}
		...
		FourNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q1 && !p3q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionSeven));
					alertDialog.show();
					wrongSound.start();
					p4q1=false;
					}
		...
		FourNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q2 && !p4q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionEight));
					alertDialog.show();
					wrongSound.start();
					p4q2=false;
		...
		FiveNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q1 && !p4q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionNine));
					alertDialog.show();
					wrongSound.start();
					p5q1=false;
					}
		...
		FiveNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q2 && !p5q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionTen));
					alertDialog.show();
					wrongSound.start();
					p5q2=false;
					}
		...
		SixNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q1 && !p5q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionEleven));
					alertDialog.show();
					wrongSound.start();
					p6q1=false;
					}
 		...
 		SixYesOne.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q2 && !p6q1) {
					...
					DataHolder entry = new DataHolder(SimpleFrame15.this);
				...
				if (p6q2  && !p6q1) {
					...
					linearLayoutSix.setBackgroundResource(R.drawable.nice_background_greener);
						...
						double nTHEN = (((double)p5+p6)/4) * 100;
							...
							alertDialog.setTitle(getResources().getString(R.string.oops));
							alertDialog.setMessage(getResources().getString(R.string.SimpleFifteenErrorCorrectionTwelve));
							alertDialog.show();
