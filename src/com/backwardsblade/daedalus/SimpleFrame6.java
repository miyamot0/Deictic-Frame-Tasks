...
public class SimpleFrame6 extends Activity {
	...
	int p1=0; int p2=0;	int p3=0; int p4=0; int p5=0; int p6=0; int lesson=106;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.simpleframe6);
		...
		Button OneYes = (Button) findViewById(R.id.SimpleSixButton1);
		Button OneNo = (Button) findViewById(R.id.SimpleSixButton2);		
		Button OneYesOne = (Button) findViewById(R.id.SimpleSixButton3);
		Button OneNoTwo = (Button) findViewById(R.id.SimpleSixButton4);		
		Button TwoYes = (Button) findViewById(R.id.SimpleSixButton5);
		Button TwoNo = (Button) findViewById(R.id.SimpleSixButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.SimpleSixButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.SimpleSixButton8);				
		Button ThreeYes = (Button) findViewById(R.id.SimpleSixButton9);
		Button ThreeNo = (Button) findViewById(R.id.SimpleSixButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.SimpleSixButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.SimpleSixButton12);
		Button FourYes = (Button) findViewById(R.id.SimpleSixButton13);
		Button FourNo = (Button) findViewById(R.id.SimpleSixButton14);				
		Button FourYesOne = (Button) findViewById(R.id.SimpleSixButton15);
		Button FourNoTwo = (Button) findViewById(R.id.SimpleSixButton16);		
		Button FiveYes = (Button) findViewById(R.id.SimpleSixButton17);
		Button FiveNo = (Button) findViewById(R.id.SimpleSixButton18);
		Button FiveYesOne = (Button) findViewById(R.id.SimpleSixButton19);
		Button FiveNoTwo = (Button) findViewById(R.id.SimpleSixButton20);		
		Button SixYes = (Button) findViewById(R.id.SimpleSixButton21);
		Button SixNo = (Button) findViewById(R.id.SimpleSixButton22);
		Button SixYesOne = (Button) findViewById(R.id.SimpleSixButton23);
		Button SixNoTwo = (Button) findViewById(R.id.SimpleSixButton24);
		...
		OneNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionOne));
					alertDialog.show();
					wrongSound.start();
					p1q1=false;
					}
		...
		OneNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q2 && !p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionTwo));
					alertDialog.show();
					wrongSound.start();
					p1q2=false;
		...
		TwoNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q1 && !p1q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionThree));
					alertDialog.show();
					wrongSound.start();
					p2q1=false;
					}				
		...
		TwoNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q2 && !p2q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionFour));
					alertDialog.show();
					wrongSound.start();
					p2q2=false;
		...
		ThreeNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q1 && !p2q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionFive));
					alertDialog.show();
					wrongSound.start();
					p3q1=false;
				}
		...
		ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q2 && !p3q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionSix));
					alertDialog.show();
					wrongSound.start();
					p3q2=false;
					}
		...
		FourNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q1 && !p3q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionSeven));
					alertDialog.show();
					wrongSound.start();
					p4q1=false;
					}
		...
		FourNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q2 && !p4q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionEight));
					alertDialog.show();
					wrongSound.start();
					p4q2=false;
		...
		FiveNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q1 && !p4q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionNine));
					alertDialog.show();
					wrongSound.start();
					p5q1=false;
					}
		...
		FiveNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q2 && !p5q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionTen));
					alertDialog.show();
					wrongSound.start();
					p5q2=false;
					}
		...
		SixNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q1 && !p5q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionEleven));
					alertDialog.show();
					wrongSound.start();
					p6q1=false;
					}
 		...
 		SixYesOne.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q2 && !p6q1) {
					...
					DataHolder entry = new DataHolder(SimpleFrame6.this);
				...
				if (p6q2  && !p6q1) {
					...
					linearLayoutSix.setBackgroundResource(R.drawable.nice_background_greener);
						...
						double nTHEN = (((double)p5+p6)/4) * 100;
							...
							alertDialog.setTitle(getResources().getString(R.string.oops));
							alertDialog.setMessage(getResources().getString(R.string.SimpleSixErrorCorrectionTwelve));
							alertDialog.show();
