...
public class SimpleFrame13 extends Activity {
	...
	int p1=0; int p2=0;	int p3=0; int p4=0; int p5=0; int p6=0; int lesson=113;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.simpleframe13);
		...
		Button OneYes = (Button) findViewById(R.id.SimpleThirteenButton1);
		Button OneNo = (Button) findViewById(R.id.SimpleThirteenButton2);		
		Button OneYesOne = (Button) findViewById(R.id.SimpleThirteenButton3);
		Button OneNoTwo = (Button) findViewById(R.id.SimpleThirteenButton4);		
		Button TwoYes = (Button) findViewById(R.id.SimpleThirteenButton5);
		Button TwoNo = (Button) findViewById(R.id.SimpleThirteenButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.SimpleThirteenButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.SimpleThirteenButton8);				
		Button ThreeYes = (Button) findViewById(R.id.SimpleThirteenButton9);
		Button ThreeNo = (Button) findViewById(R.id.SimpleThirteenButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.SimpleThirteenButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.SimpleThirteenButton12);
		Button FourYes = (Button) findViewById(R.id.SimpleThirteenButton13);
		Button FourNo = (Button) findViewById(R.id.SimpleThirteenButton14);				
		Button FourYesOne = (Button) findViewById(R.id.SimpleThirteenButton15);
		Button FourNoTwo = (Button) findViewById(R.id.SimpleThirteenButton16);		
		Button FiveYes = (Button) findViewById(R.id.SimpleThirteenButton17);
		Button FiveNo = (Button) findViewById(R.id.SimpleThirteenButton18);
		Button FiveYesOne = (Button) findViewById(R.id.SimpleThirteenButton19);
		Button FiveNoTwo = (Button) findViewById(R.id.SimpleThirteenButton20);		
		Button SixYes = (Button) findViewById(R.id.SimpleThirteenButton21);
		Button SixNo = (Button) findViewById(R.id.SimpleThirteenButton22);
		Button SixYesOne = (Button) findViewById(R.id.SimpleThirteenButton23);
		...
		OneNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionOne));
					alertDialog.show();
					wrongSound.start();
					p1q1=false;
					}
		...
		OneNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q2 && !p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionTwo));
					alertDialog.show();
					wrongSound.start();
					p1q2=false;
		...
		TwoNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q1 && !p1q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionThree));
					alertDialog.show();
					wrongSound.start();
					p2q1=false;
					}				
		...
		TwoNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q2 && !p2q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionFour));
					alertDialog.show();
					wrongSound.start();
					p2q2=false;
		...
		ThreeNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q1 && !p2q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionFive));
					alertDialog.show();
					wrongSound.start();
					p3q1=false;
				}
		...
		ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q2 && !p3q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionSix));
					alertDialog.show();
					wrongSound.start();
					p3q2=false;
					}
		...
		FourNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q1 && !p3q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionSeven));
					alertDialog.show();
					wrongSound.start();
					p4q1=false;
					}
		...
		FourNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q2 && !p4q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionEight));
					alertDialog.show();
					wrongSound.start();
					p4q2=false;
		...
		FiveNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q1 && !p4q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionNine));
					alertDialog.show();
					wrongSound.start();
					p5q1=false;
					}
		...
		FiveNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q2 && !p5q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionTen));
					alertDialog.show();
					wrongSound.start();
					p5q2=false;
					}
		...
		SixNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q1 && !p5q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionEleven));
					alertDialog.show();
					wrongSound.start();
					p6q1=false;
					}
 		...
 		SixYesOne.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q2 && !p6q1) {
					...
					DataHolder entry = new DataHolder(SimpleFrame13.this);
				...
				if (p6q2  && !p6q1) {
					...
					linearLayoutSix.setBackgroundResource(R.drawable.nice_background_greener);
						...
						double nTHEN = (((double)p5+p6)/4) * 100;
							...
							alertDialog.setTitle(getResources().getString(R.string.oops));
							alertDialog.setMessage(getResources().getString(R.string.SimpleThirteenErrorCorrectionTwelve));
							alertDialog.show();
