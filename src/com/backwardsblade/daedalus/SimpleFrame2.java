...
public class SimpleFrame2 extends Activity {
	...
	int p1=0; int p2=0;	int p3=0; int p4=0; int p5=0; int p6=0; int lesson=102;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.simpleframe2);

		final CharSequence[] names = getResources().getStringArray(R.array.studentNames);		
		
		final LinearLayout linearLayoutOne = (LinearLayout)findViewById(R.id.SimpleTwolayoutNumberOne);
		final LinearLayout linearLayoutTwo = (LinearLayout)findViewById(R.id.SimpleTwolayoutNumberTwo);
		final LinearLayout linearLayoutThree = (LinearLayout)findViewById(R.id.SimpleTwolayoutNumberThree);
		final LinearLayout linearLayoutFour = (LinearLayout)findViewById(R.id.SimpleTwolayoutNumberFour);
		final LinearLayout linearLayoutFive = (LinearLayout)findViewById(R.id.SimpleTwolayoutNumberFive);
		final LinearLayout linearLayoutSix = (LinearLayout)findViewById(R.id.SimpleTwolayoutNumberSix);
		...
		Button OneYes = (Button) findViewById(R.id.SimpleTwoButton1);
		Button OneNo = (Button) findViewById(R.id.SimpleTwoButton2);		
		Button OneYesOne = (Button) findViewById(R.id.SimpleTwoButton3);
		Button OneNoTwo = (Button) findViewById(R.id.SimpleTwoButton4);		
		Button TwoYes = (Button) findViewById(R.id.SimpleTwoButton5);
		Button TwoNo = (Button) findViewById(R.id.SimpleTwoButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.SimpleTwoButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.SimpleTwoButton8);				
		Button ThreeYes = (Button) findViewById(R.id.SimpleTwoButton9);
		Button ThreeNo = (Button) findViewById(R.id.SimpleTwoButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.SimpleTwoButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.SimpleTwoButton12);
		Button FourYes = (Button) findViewById(R.id.SimpleTwoButton13);
		Button FourNo = (Button) findViewById(R.id.SimpleTwoButton14);				
		Button FourYesOne = (Button) findViewById(R.id.SimpleTwoButton15);
		Button FourNoTwo = (Button) findViewById(R.id.SimpleTwoButton16);		
		Button FiveYes = (Button) findViewById(R.id.SimpleTwoButton17);
		Button FiveNo = (Button) findViewById(R.id.SimpleTwoButton18);
		Button FiveYesOne = (Button) findViewById(R.id.SimpleTwoButton19);
		Button FiveNoTwo = (Button) findViewById(R.id.SimpleTwoButton20);		
		Button SixYes = (Button) findViewById(R.id.SimpleTwoButton21);
		Button SixNo = (Button) findViewById(R.id.SimpleTwoButton22);
		Button SixYesOne = (Button) findViewById(R.id.SimpleTwoButton23);
		Button SixNoTwo = (Button) findViewById(R.id.SimpleTwoButton24);
		...
		OneNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionOne));
					alertDialog.show();
					wrongSound.start();
					p1q1=false;
					}
		...
		OneNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q2 && !p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionTwo));
					alertDialog.show();
					wrongSound.start();
					p1q2=false;
		...
		TwoNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q1 && !p1q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionThree));
					alertDialog.show();
					wrongSound.start();
					p2q1=false;
					}				
		...
		TwoNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q2 && !p2q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionFour));
					alertDialog.show();
					wrongSound.start();
					p2q2=false;
		...
		ThreeNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q1 && !p2q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionFive));
					alertDialog.show();
					wrongSound.start();
					p3q1=false;
				}
		...
		ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q2 && !p3q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionSix));
					alertDialog.show();
					wrongSound.start();
					p3q2=false;
					}
		...
		FourNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q1 && !p3q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionSeven));
					alertDialog.show();
					wrongSound.start();
					p4q1=false;
					}
		...
		FourNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q2 && !p4q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionEight));
					alertDialog.show();
					wrongSound.start();
					p4q2=false;
		...
		FiveNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q1 && !p4q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionNine));
					alertDialog.show();
					wrongSound.start();
					p5q1=false;
					}
		...
		FiveNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q2 && !p5q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionTen));
					alertDialog.show();
					wrongSound.start();
					p5q2=false;
					}
		...
		SixNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q1 && !p5q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionEleven));
					alertDialog.show();
					wrongSound.start();
					p6q1=false;
					}
 		...
 		SixYesOne.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q2 && !p6q1) {
					...
					DataHolder entry = new DataHolder(SimpleFrame2.this);
				...
				if (p6q2  && !p6q1) {
					...
					linearLayoutSix.setBackgroundResource(R.drawable.nice_background_greener);
						...
						double nTHEN = (((double)p5+p6)/4) * 100;
							...
							alertDialog.setTitle(getResources().getString(R.string.oops));
							alertDialog.setMessage(getResources().getString(R.string.SimpleTwoErrorCorrectionTwelve));
							alertDialog.show();
