...
public class SimpleFrame14 extends Activity {
	...
	int p1=0; int p2=0;	int p3=0; int p4=0; int p5=0; int p6=0; int lesson=114;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.simpleframe14);
		...
		Button OneYes = (Button) findViewById(R.id.SimpleFourteenButton1);
		Button OneNo = (Button) findViewById(R.id.SimpleFourteenButton2);		
		Button OneYesOne = (Button) findViewById(R.id.SimpleFourteenButton3);
		Button OneNoTwo = (Button) findViewById(R.id.SimpleFourteenButton4);		
		Button TwoYes = (Button) findViewById(R.id.SimpleFourteenButton5);
		Button TwoNo = (Button) findViewById(R.id.SimpleFourteenButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.SimpleFourteenButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.SimpleFourteenButton8);				
		Button ThreeYes = (Button) findViewById(R.id.SimpleFourteenButton9);
		Button ThreeNo = (Button) findViewById(R.id.SimpleFourteenButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.SimpleFourteenButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.SimpleFourteenButton12);
		Button FourYes = (Button) findViewById(R.id.SimpleFourteenButton13);
		Button FourNo = (Button) findViewById(R.id.SimpleFourteenButton14);				
		Button FourYesOne = (Button) findViewById(R.id.SimpleFourteenButton15);
		Button FourNoTwo = (Button) findViewById(R.id.SimpleFourteenButton16);		
		Button FiveYes = (Button) findViewById(R.id.SimpleFourteenButton17);
		Button FiveNo = (Button) findViewById(R.id.SimpleFourteenButton18);
		Button FiveYesOne = (Button) findViewById(R.id.SimpleFourteenButton19);
		Button FiveNoTwo = (Button) findViewById(R.id.SimpleFourteenButton20);		
		Button SixYes = (Button) findViewById(R.id.SimpleFourteenButton21);
		Button SixNo = (Button) findViewById(R.id.SimpleFourteenButton22);
		Button SixYesOne = (Button) findViewById(R.id.SimpleFourteenButton23);
		Button SixNoTwo = (Button) findViewById(R.id.SimpleFourteenButton24);
		...
		OneNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionOne));
					alertDialog.show();
					wrongSound.start();
					p1q1=false;
					}
		...
		OneNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q2 && !p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionTwo));
					alertDialog.show();
					wrongSound.start();
					p1q2=false;
		...
		TwoNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q1 && !p1q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionThree));
					alertDialog.show();
					wrongSound.start();
					p2q1=false;
					}				
		...
		TwoNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q2 && !p2q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionFour));
					alertDialog.show();
					wrongSound.start();
					p2q2=false;
		...
		ThreeNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q1 && !p2q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionFive));
					alertDialog.show();
					wrongSound.start();
					p3q1=false;
				}
		...
		ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q2 && !p3q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionSix));
					alertDialog.show();
					wrongSound.start();
					p3q2=false;
					}
		...
		FourNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q1 && !p3q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionSeven));
					alertDialog.show();
					wrongSound.start();
					p4q1=false;
					}
		...
		FourNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q2 && !p4q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionEight));
					alertDialog.show();
					wrongSound.start();
					p4q2=false;
		...
		FiveNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q1 && !p4q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionNine));
					alertDialog.show();
					wrongSound.start();
					p5q1=false;
					}
		...
		FiveNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q2 && !p5q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionTen));
					alertDialog.show();
					wrongSound.start();
					p5q2=false;
					}
		...
		SixNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q1 && !p5q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionEleven));
					alertDialog.show();
					wrongSound.start();
					p6q1=false;
					}
 		...
 		SixYesOne.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q2 && !p6q1) {
					...
					DataHolder entry = new DataHolder(SimpleFrame14.this);
				...
				if (p6q2  && !p6q1) {
					...
					linearLayoutSix.setBackgroundResource(R.drawable.nice_background_greener);
						...
						double nTHEN = (((double)p5+p6)/4) * 100;
							...
							alertDialog.setTitle(getResources().getString(R.string.oops));
							alertDialog.setMessage(getResources().getString(R.string.SimpleFourteenErrorCorrectionTwelve));
							alertDialog.show();
