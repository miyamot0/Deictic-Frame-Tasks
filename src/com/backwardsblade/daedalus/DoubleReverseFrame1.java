...
public class DoubleReverseFrame1 extends Activity {
	...
	int p1=0; int p2=0;	int p3=0; int p4=0; int p5=0; int lesson=301;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.doublereverseframe1);
		...
		Button OneYes = (Button) findViewById(R.id.DoubleReversedOneButton1);
		Button OneNo = (Button) findViewById(R.id.DoubleReversedOneButton2);		
		Button OneYesOne = (Button) findViewById(R.id.DoubleReversedOneButton3);
		Button OneNoTwo = (Button) findViewById(R.id.DoubleReversedOneButton4);		
		Button TwoYes = (Button) findViewById(R.id.DoubleReversedOneButton5);
		Button TwoNo = (Button) findViewById(R.id.DoubleReversedOneButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.DoubleReversedOneButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.DoubleReversedOneButton8);				
		Button ThreeYes = (Button) findViewById(R.id.DoubleReversedOneButton9);
		Button ThreeNo = (Button) findViewById(R.id.DoubleReversedOneButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.DoubleReversedOneButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.DoubleReversedOneButton12);
		Button FourYes = (Button) findViewById(R.id.DoubleReversedOneButton13);
		Button FourNo = (Button) findViewById(R.id.DoubleReversedOneButton14);				
		Button FourYesOne = (Button) findViewById(R.id.DoubleReversedOneButton15);
		Button FourNoTwo = (Button) findViewById(R.id.DoubleReversedOneButton16);		
		Button FiveYes = (Button) findViewById(R.id.DoubleReversedOneButton17);
		Button FiveNo = (Button) findViewById(R.id.DoubleReversedOneButton18);
		Button FiveYesOne = (Button) findViewById(R.id.DoubleReversedOneButton19);
	...
	OneNo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p1q1) {
				...
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedOneErrorCorrectionOne));
				alertDialog.show();
				wrongSound.start();
				p1q1=false;
				}
	...
	OneNoTwo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p1q2 && !p1q1) {
				...
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedOneErrorCorrectionTwo));
				alertDialog.show();
				wrongSound.start();
				p1q2=false;
			linearLayoutOne.setBackgroundResource(R.drawable.background_red);
	...
	TwoNo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p2q1 && !p1q2) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedOneErrorCorrectionThree));
				alertDialog.show();
				wrongSound.start();
				p2q1=false;
				}				
	...
	TwoNoTwo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p2q2 && !p2q1) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedOneErrorCorrectionFour));
				alertDialog.show();
				wrongSound.start();
				p2q2=false;
			linearLayoutTwo.setBackgroundResource(R.drawable.background_red);
	...
	ThreeNo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p3q1 && !p2q2) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedOneErrorCorrectionFive));
				alertDialog.show();
				wrongSound.start();
				p3q1=false;
			}
	...
	ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p3q2 && !p3q1) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedOneErrorCorrectionSix));
				alertDialog.show();
				wrongSound.start();
				p3q2=false;
	...
	FourNo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p4q1 && !p3q2) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedOneErrorCorrectionSeven));
				alertDialog.show();
				wrongSound.start();
				p4q1=false;
				}
	...
	FourNoTwo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p4q2 && !p4q1) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedOneErrorCorrectionEight));
				alertDialog.show();
				wrongSound.start();
				p4q2=false;
			linearLayoutFour.setBackgroundResource(R.drawable.background_red);
	...
	FiveNo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p5q1 && !p4q2) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedOneErrorCorrectionNine));
				alertDialog.show();
				wrongSound.start();
				p5q1=false;
				}
		...
		public void onClick(View v) {
			...
			if (p5q2 && !p5q1) {
				...
				DataHolder entry = new DataHolder(DoubleReverseFrame1.this);
	...
	FiveNoTwo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p5q2 && !p5q1) {
				...
				p5q2=false;
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedOneErrorCorrectionTen));
				alertDialog.show();
			linearLayoutFive.setBackgroundResource(R.drawable.background_red);
