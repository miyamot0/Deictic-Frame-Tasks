...
public class ReverseFrame14 extends Activity {
	...
	int p1=0; int p2=0;	int p3=0; int p4=0; int p5=0; int p6=0; int p7=0; int lesson=214;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.reverseframe14);
		...
		Button OneYes = (Button) findViewById(R.id.ReversedFourteenButton1);
		Button OneNo = (Button) findViewById(R.id.ReversedFourteenButton2);		
		Button OneYesOne = (Button) findViewById(R.id.ReversedFourteenButton3);
		Button OneNoTwo = (Button) findViewById(R.id.ReversedFourteenButton4);		
		Button TwoYes = (Button) findViewById(R.id.ReversedFourteenButton5);
		Button TwoNo = (Button) findViewById(R.id.ReversedFourteenButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.ReversedFourteenButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.ReversedFourteenButton8);				
		Button ThreeYes = (Button) findViewById(R.id.ReversedFourteenButton9);
		Button ThreeNo = (Button) findViewById(R.id.ReversedFourteenButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.ReversedFourteenButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.ReversedFourteenButton12);
		Button FourYes = (Button) findViewById(R.id.ReversedFourteenButton13);
		Button FourNo = (Button) findViewById(R.id.ReversedFourteenButton14);				
		Button FourYesOne = (Button) findViewById(R.id.ReversedFourteenButton15);
		Button FourNoTwo = (Button) findViewById(R.id.ReversedFourteenButton16);		
		Button FiveYes = (Button) findViewById(R.id.ReversedFourteenButton17);
		Button FiveNo = (Button) findViewById(R.id.ReversedFourteenButton18);
		Button FiveYesOne = (Button) findViewById(R.id.ReversedFourteenButton19);
		Button FiveNoTwo = (Button) findViewById(R.id.ReversedFourteenButton20);		
		Button SixYes = (Button) findViewById(R.id.ReversedFourteenButton21);
		Button SixNo = (Button) findViewById(R.id.ReversedFourteenButton22);
		Button SixYesOne = (Button) findViewById(R.id.ReversedFourteenButton23);
		Button SixNoTwo = (Button) findViewById(R.id.ReversedFourteenButton24);
		Button SevenYes = (Button) findViewById(R.id.ReversedFourteenButton25);
		Button SevenNo = (Button) findViewById(R.id.ReversedFourteenButton26);
		Button SevenYesOne = (Button) findViewById(R.id.ReversedFourteenButton27);
		...
		OneNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionOne));
					alertDialog.show();
					wrongSound.start();
					p1q1=false;
					}
		...
		OneNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q2 && !p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionTwo));
					alertDialog.show();
					wrongSound.start();
					p1q2=false;
				linearLayoutOne.setBackgroundResource(R.drawable.background_blue);
		...
		TwoNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q1 && !p1q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionThree));
					alertDialog.show();
					wrongSound.start();
					p2q1=false;
					}				
		...
		TwoNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q2 && !p2q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionFour));
					alertDialog.show();
					wrongSound.start();
					p2q2=false;
				linearLayoutTwo.setBackgroundResource(R.drawable.background_blue);
		...
		ThreeNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q1 && !p2q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionFive));
					alertDialog.show();
					wrongSound.start();
					p3q1=false;
				}
		...
		ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q2 && !p3q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionSix));
					alertDialog.show();
					wrongSound.start();
					p3q2=false;
		...
		FourNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q1 && !p3q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionSeven));
					alertDialog.show();
					wrongSound.start();
					p4q1=false;
					}
		...
		FourNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q2 && !p4q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionEight));
					alertDialog.show();
					wrongSound.start();
					p4q2=false;
				linearLayoutFour.setBackgroundResource(R.drawable.background_blue);
		...
		FiveNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q1 && !p4q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionNine));
					alertDialog.show();
					wrongSound.start();
					p5q1=false;
					}
		...
		FiveNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q2 && !p5q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionTen));
					alertDialog.show();
					wrongSound.start();
					p5q2=false;
				linearLayoutFive.setBackgroundResource(R.drawable.background_blue);
		...
		SixNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q1 && !p5q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionEleven));
					alertDialog.show();
					wrongSound.start();
					p6q1=false;
					}
		...
		SixNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q2  && !p6q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionTwelve));
					alertDialog.show();
					wrongSound.start();
					p6q2=false;
					linearLayoutSix.setBackgroundResource(R.drawable.background_blue);
		...
		SevenNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p7q1 && !p6q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedFourteenErrorCorrectionThirteen));
					alertDialog.show();
					wrongSound.start();
					p7q1=false;
			}}
 		...
 		SevenYesOne.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p7q2 && !p7q1) {
					...
					DataHolder entry = new DataHolder(ReverseFrame14.this);
