...
public class SimpleFrame4 extends Activity {
	...
	int p1=0; int p2=0;	int p3=0; int p4=0; int p5=0; int p6=0; int lesson=104;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.simpleframe4);
		...
		Button OneYes = (Button) findViewById(R.id.SimpleFourButton1);
		Button OneNo = (Button) findViewById(R.id.SimpleFourButton2);		
		Button OneYesOne = (Button) findViewById(R.id.SimpleFourButton3);
		Button OneNoTwo = (Button) findViewById(R.id.SimpleFourButton4);		
		Button TwoYes = (Button) findViewById(R.id.SimpleFourButton5);
		Button TwoNo = (Button) findViewById(R.id.SimpleFourButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.SimpleFourButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.SimpleFourButton8);				
		Button ThreeYes = (Button) findViewById(R.id.SimpleFourButton9);
		Button ThreeNo = (Button) findViewById(R.id.SimpleFourButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.SimpleFourButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.SimpleFourButton12);
		Button FourYes = (Button) findViewById(R.id.SimpleFourButton13);
		Button FourNo = (Button) findViewById(R.id.SimpleFourButton14);				
		Button FourYesOne = (Button) findViewById(R.id.SimpleFourButton15);
		Button FourNoTwo = (Button) findViewById(R.id.SimpleFourButton16);		
		Button FiveYes = (Button) findViewById(R.id.SimpleFourButton17);
		Button FiveNo = (Button) findViewById(R.id.SimpleFourButton18);
		Button FiveYesOne = (Button) findViewById(R.id.SimpleFourButton19);
		Button FiveNoTwo = (Button) findViewById(R.id.SimpleFourButton20);		
		Button SixYes = (Button) findViewById(R.id.SimpleFourButton21);
		Button SixNo = (Button) findViewById(R.id.SimpleFourButton22);
		Button SixYesOne = (Button) findViewById(R.id.SimpleFourButton23);
		Button SixNoTwo = (Button) findViewById(R.id.SimpleFourButton24);
		...
		OneNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionOne));
					alertDialog.show();
					wrongSound.start();
					p1q1=false;
					}
		...
		OneNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q2 && !p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionTwo));
					alertDialog.show();
					wrongSound.start();
					p1q2=false;
		...
		TwoNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q1 && !p1q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionThree));
					alertDialog.show();
					wrongSound.start();
					p2q1=false;
					}				
		...
		TwoNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q2 && !p2q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionFour));
					alertDialog.show();
					wrongSound.start();
					p2q2=false;
		...
		ThreeNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q1 && !p2q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionFive));
					alertDialog.show();
					wrongSound.start();
					p3q1=false;
				}
		...
		ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q2 && !p3q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionSix));
					alertDialog.show();
					wrongSound.start();
					p3q2=false;
					}
		...
		FourNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q1 && !p3q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionSeven));
					alertDialog.show();
					wrongSound.start();
					p4q1=false;
					}
		...
		FourNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q2 && !p4q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionEight));
					alertDialog.show();
					wrongSound.start();
					p4q2=false;
		...
		FiveNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q1 && !p4q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionNine));
					alertDialog.show();
					wrongSound.start();
					p5q1=false;
					}
		...
		FiveNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q2 && !p5q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionTen));
					alertDialog.show();
					wrongSound.start();
					p5q2=false;
					}
		...
		SixNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q1 && !p5q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionEleven));
					alertDialog.show();
					wrongSound.start();
					p6q1=false;
					}
 		...
 		SixYesOne.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q2 && !p6q1) {
					...
					DataHolder entry = new DataHolder(SimpleFrame4.this);
				...
				if (p6q2  && !p6q1) {
					...
					linearLayoutSix.setBackgroundResource(R.drawable.nice_background_greener);
						...
						double nTHEN = (((double)p5+p6)/4) * 100;
							...
							alertDialog.setTitle(getResources().getString(R.string.oops));
							alertDialog.setMessage(getResources().getString(R.string.SimpleFourErrorCorrectionTwelve));
							alertDialog.show();
