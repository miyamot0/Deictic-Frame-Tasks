...
public class DoubleReverseFrame4 extends Activity {
	...
	int p1=0; int p2=0;	int p3=0; int p4=0; int p5=0; int lesson=304;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.doublereverseframe4);
		...
		Button OneYes = (Button) findViewById(R.id.DoubleReversedFourButton1);
		Button OneNo = (Button) findViewById(R.id.DoubleReversedFourButton2);		
		Button OneYesOne = (Button) findViewById(R.id.DoubleReversedFourButton3);
		Button OneNoTwo = (Button) findViewById(R.id.DoubleReversedFourButton4);		
		Button TwoYes = (Button) findViewById(R.id.DoubleReversedFourButton5);
		Button TwoNo = (Button) findViewById(R.id.DoubleReversedFourButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.DoubleReversedFourButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.DoubleReversedFourButton8);				
		Button ThreeYes = (Button) findViewById(R.id.DoubleReversedFourButton9);
		Button ThreeNo = (Button) findViewById(R.id.DoubleReversedFourButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.DoubleReversedFourButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.DoubleReversedFourButton12);
		Button FourYes = (Button) findViewById(R.id.DoubleReversedFourButton13);
		Button FourNo = (Button) findViewById(R.id.DoubleReversedFourButton14);				
		Button FourYesOne = (Button) findViewById(R.id.DoubleReversedFourButton15);
		Button FourNoTwo = (Button) findViewById(R.id.DoubleReversedFourButton16);		
		Button FiveYes = (Button) findViewById(R.id.DoubleReversedFourButton17);
		Button FiveNo = (Button) findViewById(R.id.DoubleReversedFourButton18);
		Button FiveYesOne = (Button) findViewById(R.id.DoubleReversedFourButton19);
		Button FiveNoTwo = (Button) findViewById(R.id.DoubleReversedFourButton20);				
	...
	OneNo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p1q1) {
				...
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedFourErrorCorrectionOne));
				alertDialog.show();
				wrongSound.start();
				p1q1=false;
				}
	...
	OneNoTwo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p1q2 && !p1q1) {
				...
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedFourErrorCorrectionTwo));
				alertDialog.show();
				wrongSound.start();
				p1q2=false;
			linearLayoutOne.setBackgroundResource(R.drawable.background_red);
	...
	TwoNo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p2q1 && !p1q2) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedFourErrorCorrectionThree));
				alertDialog.show();
				wrongSound.start();
				p2q1=false;
				}				
	...
	TwoNoTwo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p2q2 && !p2q1) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedFourErrorCorrectionFour));
				alertDialog.show();
				wrongSound.start();
				p2q2=false;
			linearLayoutTwo.setBackgroundResource(R.drawable.background_red);
	...
	ThreeNo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p3q1 && !p2q2) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedFourErrorCorrectionFive));
				alertDialog.show();
				wrongSound.start();
				p3q1=false;
			}
	...
	ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p3q2 && !p3q1) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedFourErrorCorrectionSix));
				alertDialog.show();
				wrongSound.start();
				p3q2=false;
	...
	FourNo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p4q1 && !p3q2) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedFourErrorCorrectionSeven));
				alertDialog.show();
				wrongSound.start();
				p4q1=false;
				}
	...
	FourNoTwo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p4q2 && !p4q1) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedFourErrorCorrectionEight));
				alertDialog.show();
				wrongSound.start();
				p4q2=false;
			linearLayoutFour.setBackgroundResource(R.drawable.background_red);
	...
	FiveNo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p5q1 && !p4q2) {
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedFourErrorCorrectionNine));
				alertDialog.show();
				wrongSound.start();
				p5q1=false;
				}
		...
		public void onClick(View v) {
			...
			if (p5q2 && !p5q1) {
				...
				DataHolder entry = new DataHolder(DoubleReverseFrame4.this);
	...
	FiveNoTwo.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			...
			if (p5q2 && !p5q1) {
				...
				p5q2=false;
				alertDialog.setTitle(getResources().getString(R.string.oops));
				alertDialog.setMessage(getResources().getString(R.string.DoubleReversedFourErrorCorrectionTen));
				alertDialog.show();
			linearLayoutFive.setBackgroundResource(R.drawable.background_red);
