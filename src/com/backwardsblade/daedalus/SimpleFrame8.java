...
public class SimpleFrame8 extends Activity {
	...
	int p1=0; int p2=0;	int p3=0; int p4=0; int p5=0; int p6=0; int lesson=108;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.simpleframe8);
		...
		Button OneYes = (Button) findViewById(R.id.SimpleEightButton1);
		Button OneNo = (Button) findViewById(R.id.SimpleEightButton2);		
		Button OneYesOne = (Button) findViewById(R.id.SimpleEightButton3);
		Button OneNoTwo = (Button) findViewById(R.id.SimpleEightButton4);		
		Button TwoYes = (Button) findViewById(R.id.SimpleEightButton5);
		Button TwoNo = (Button) findViewById(R.id.SimpleEightButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.SimpleEightButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.SimpleEightButton8);				
		Button ThreeYes = (Button) findViewById(R.id.SimpleEightButton9);
		Button ThreeNo = (Button) findViewById(R.id.SimpleEightButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.SimpleEightButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.SimpleEightButton12);
		Button FourYes = (Button) findViewById(R.id.SimpleEightButton13);
		Button FourNo = (Button) findViewById(R.id.SimpleEightButton14);				
		Button FourYesOne = (Button) findViewById(R.id.SimpleEightButton15);
		Button FourNoTwo = (Button) findViewById(R.id.SimpleEightButton16);		
		Button FiveYes = (Button) findViewById(R.id.SimpleEightButton17);
		Button FiveNo = (Button) findViewById(R.id.SimpleEightButton18);
		Button FiveYesOne = (Button) findViewById(R.id.SimpleEightButton19);
		Button FiveNoTwo = (Button) findViewById(R.id.SimpleEightButton20);		
		Button SixYes = (Button) findViewById(R.id.SimpleEightButton21);
		Button SixNo = (Button) findViewById(R.id.SimpleEightButton22);
		Button SixYesOne = (Button) findViewById(R.id.SimpleEightButton23);
		Button SixNoTwo = (Button) findViewById(R.id.SimpleEightButton24);
		...
		OneNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionOne));
					alertDialog.show();
					wrongSound.start();
					p1q1=false;
					}
		...
		OneNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q2 && !p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionTwo));
					alertDialog.show();
					wrongSound.start();
					p1q2=false;
		...
		TwoNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q1 && !p1q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionThree));
					alertDialog.show();
					wrongSound.start();
					p2q1=false;
					}				
		...
		TwoNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q2 && !p2q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionFour));
					alertDialog.show();
					wrongSound.start();
					p2q2=false;
		...
		ThreeNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q1 && !p2q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionFive));
					alertDialog.show();
					wrongSound.start();
					p3q1=false;
				}
		...
		ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q2 && !p3q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionSix));
					alertDialog.show();
					wrongSound.start();
					p3q2=false;
					}
		...
		FourNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q1 && !p3q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionSeven));
					alertDialog.show();
					wrongSound.start();
					p4q1=false;
					}
		...
		FourNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q2 && !p4q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionEight));
					alertDialog.show();
					wrongSound.start();
					p4q2=false;
		...
		FiveNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q1 && !p4q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionNine));
					alertDialog.show();
					wrongSound.start();
					p5q1=false;
					}
		...
		FiveNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q2 && !p5q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionTen));
					alertDialog.show();
					wrongSound.start();
					p5q2=false;
					}
		...
		SixNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q1 && !p5q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionEleven));
					alertDialog.show();
					wrongSound.start();
					p6q1=false;
					}
 		...
 		SixYesOne.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q2 && !p6q1) {
					...
					DataHolder entry = new DataHolder(SimpleFrame8.this);
				...
				if (p6q2  && !p6q1) {
					...
					linearLayoutSix.setBackgroundResource(R.drawable.nice_background_greener);
						...
						double nTHEN = (((double)p5+p6)/4) * 100;
							...
							alertDialog.setTitle(getResources().getString(R.string.oops));
							alertDialog.setMessage(getResources().getString(R.string.SimpleEightErrorCorrectionTwelve));
							alertDialog.show();
