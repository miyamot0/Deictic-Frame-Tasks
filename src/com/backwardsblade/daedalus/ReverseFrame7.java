...
public class ReverseFrame7 extends Activity {
	...
	int p1=0; int p2=0;	int p3=0; int p4=0; int p5=0; int p6=0; int p7=0; int lesson=207;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.reverseframe7);
		...
		Button OneYes = (Button) findViewById(R.id.ReversedSevenButton1);
		Button OneNo = (Button) findViewById(R.id.ReversedSevenButton2);		
		Button OneYesOne = (Button) findViewById(R.id.ReversedSevenButton3);
		Button OneNoTwo = (Button) findViewById(R.id.ReversedSevenButton4);		
		Button TwoYes = (Button) findViewById(R.id.ReversedSevenButton5);
		Button TwoNo = (Button) findViewById(R.id.ReversedSevenButton6);		
		Button TwoYesOne = (Button) findViewById(R.id.ReversedSevenButton7);
		Button TwoNoTwo = (Button) findViewById(R.id.ReversedSevenButton8);				
		Button ThreeYes = (Button) findViewById(R.id.ReversedSevenButton9);
		Button ThreeNo = (Button) findViewById(R.id.ReversedSevenButton10);		
		Button ThreeYesOne = (Button) findViewById(R.id.ReversedSevenButton11);
		Button ThreeNoTwo = (Button) findViewById(R.id.ReversedSevenButton12);
		Button FourYes = (Button) findViewById(R.id.ReversedSevenButton13);
		Button FourNo = (Button) findViewById(R.id.ReversedSevenButton14);				
		Button FourYesOne = (Button) findViewById(R.id.ReversedSevenButton15);
		Button FourNoTwo = (Button) findViewById(R.id.ReversedSevenButton16);		
		Button FiveYes = (Button) findViewById(R.id.ReversedSevenButton17);
		Button FiveNo = (Button) findViewById(R.id.ReversedSevenButton18);
		Button FiveYesOne = (Button) findViewById(R.id.ReversedSevenButton19);
		Button FiveNoTwo = (Button) findViewById(R.id.ReversedSevenButton20);		
		Button SixYes = (Button) findViewById(R.id.ReversedSevenButton21);
		Button SixNo = (Button) findViewById(R.id.ReversedSevenButton22);
		Button SixYesOne = (Button) findViewById(R.id.ReversedSevenButton23);
		Button SixNoTwo = (Button) findViewById(R.id.ReversedSevenButton24);
		Button SevenYes = (Button) findViewById(R.id.ReversedSevenButton25);
		Button SevenNo = (Button) findViewById(R.id.ReversedSevenButton26);
		Button SevenYesOne = (Button) findViewById(R.id.ReversedSevenButton27);
		Button SevenNoTwo = (Button) findViewById(R.id.ReversedSevenButton28);		
		...
		OneNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionOne));
					alertDialog.show();
					wrongSound.start();
					p1q1=false;
					}
		...
		OneNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p1q2 && !p1q1) {
					...
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionTwo));
					alertDialog.show();
					wrongSound.start();
					p1q2=false;
				linearLayoutOne.setBackgroundResource(R.drawable.background_blue);
		...
		TwoNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q1 && !p1q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionThree));
					alertDialog.show();
					wrongSound.start();
					p2q1=false;
					}				
		...
		TwoNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p2q2 && !p2q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionFour));
					alertDialog.show();
					wrongSound.start();
					p2q2=false;
				linearLayoutTwo.setBackgroundResource(R.drawable.background_blue);
		...
		ThreeNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q1 && !p2q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionFive));
					alertDialog.show();
					wrongSound.start();
					p3q1=false;
				}
		...
		ThreeNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p3q2 && !p3q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionSix));
					alertDialog.show();
					wrongSound.start();
					p3q2=false;
		...
		FourNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q1 && !p3q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionSeven));
					alertDialog.show();
					wrongSound.start();
					p4q1=false;
					}
		...
		FourNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p4q2 && !p4q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionEight));
					alertDialog.show();
					wrongSound.start();
					p4q2=false;
				linearLayoutFour.setBackgroundResource(R.drawable.background_blue);
		...
		FiveNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q1 && !p4q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionNine));
					alertDialog.show();
					wrongSound.start();
					p5q1=false;
					}
		...
		FiveNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p5q2 && !p5q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionTen));
					alertDialog.show();
					wrongSound.start();
					p5q2=false;
				linearLayoutFive.setBackgroundResource(R.drawable.background_blue);
		...
		SixNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q1 && !p5q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionEleven));
					alertDialog.show();
					wrongSound.start();
					p6q1=false;
					}
		...
		SixNoTwo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p6q2  && !p6q1) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionTwelve));
					alertDialog.show();
					wrongSound.start();
					p6q2=false;
					linearLayoutSix.setBackgroundResource(R.drawable.background_blue);
		...
		SevenNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p7q1 && !p6q2) {
					alertDialog.setTitle(getResources().getString(R.string.oops));
					alertDialog.setMessage(getResources().getString(R.string.ReversedSevenErrorCorrectionThirteen));
					alertDialog.show();
					wrongSound.start();
					p7q1=false;
			}}
 		...
 		SevenYesOne.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (p7q2 && !p7q1) {
					...
					DataHolder entry = new DataHolder(ReverseFrame7.this);
